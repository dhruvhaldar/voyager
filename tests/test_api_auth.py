...
from api.index import app, VOYAGER_API_KEY, limit_tick, limit_sensitive
...
def test_unauthenticated_command_access():
    """
    Test that critical command endpoints block unauthenticated access.
    """
...
def test_unauthenticated_telemetry_access():
    """
    Test that sensitive telemetry endpoints block unauthenticated access.
    """
